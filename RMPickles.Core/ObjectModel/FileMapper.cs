...
namespace RMPickles.Core.ObjectModel
{
    public class FileMapper
    {
        ...
        private readonly ResourceFileMapper resourceFileMapper;

        public FileMapper(IConfiguration configuration, ILanguageServices languageServices)
        {
            this.configuration = configuration;
            this.languageServices = languageServices;
            this.resourceFileMapper = new ResourceFileMapper(configuration);
        }       
        ...
        public Table MapToTable(IEnumerable<G.TableRow> tableRows)
        {
            return new Table
            {
                ...
                Comments = resourceFileMapper.MapToComments(tableRows)
            };
        }
